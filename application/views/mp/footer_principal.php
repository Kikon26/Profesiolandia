            ...
            <div class="container col-9">
                <div class="container-fluid  " style="color: #008000; text-align: left;">                
                    <strong>
                    <hr>
                    </strong>                    
                </div>
            ...
            <div class="container col-9">
                <div class="container-fluid pt-1 " style="color: #008000; text-align: left;">                
                    <strong>
                    <hr>
                    </strong>                    
                </div>
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-1" style="text-align: right;">
                            ...
                            <a href="http://www.instagram.com" target="_blank">
                              <img src="<?php echo base_url(); ?>imagenes/instagram_mini.png" style="height: 25px; width: 25px;"  alt="...">
                            </a>
            ...
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <li>
                            <div class="message-center chat-scroll">
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_5' data-user-id='5'>
                                    <span class="user-img"> <img src="<?php echo base_url(); ?>assets/images/users/5.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                    <span class="mail-contnet">
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_6' data-user-id='6'>
                                    <span class="user-img"> <img src="<?php echo base_url(); ?>assets/images/users/6.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                    <span class="mail-contnet">
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_7' data-user-id='7'>
                                    <span class="user-img"> <img src="<?php echo base_url(); ?>assets/images/users/7.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                    <span class="mail-contnet">
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_8' data-user-id='8'>
                                    <span class="user-img"> <img src="<?php echo base_url(); ?>assets/images/users/8.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                    <span class="mail-contnet">
                ...
                <div class="tab-pane fade p-15" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    ...
                    <div class="steamline">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user" src="<?php echo base_url(); ?>assets/images/users/2.jpg"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user" src="<?php echo base_url(); ?>assets/images/users/1.jpg"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user" src="<?php echo base_url(); ?>assets/images/users/4.jpg"> </div>
                            <div class="sl-right">
                                <div class="font-medium">Go to the Doctor <span class="sl-date">5 minutes ago</span></div>
                                <div class="desc">Contrary to popular belief</div>
                            </div>
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user" src="<?php echo base_url(); ?>assets/images/users/6.jpg"> </div>
                            <div class="sl-right">
                                <div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span></div>
                                <div class="desc">Approve meeting with tiger</div>
                            </div>
    ...
    <link href="<?php echo base_url(); ?>assets/libs/datatables/media/css/jquery.dataTables.min.css" rel="stylesheet">	           
    ...
    <script src="<?php echo base_url(); ?>assets/js/ajax/jszip.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/ajax/pdfmake.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/ajax/vfs_fonts.js"></script>	
    ...
    <script src="<?php echo base_url(); ?>dist/js/app.init.light-sidebar.js"></script>
	...
	<!--JavaScript General-->
	<script src="<?php echo base_url(); ?>app_js/general.js"></script>
    ...
    <!-- ============================================================== -->	
    <!-- ============================================================== -->	    
    <script src="<?php echo base_url(); ?>dist/js/pages/samplepages/jquery.PrintArea.js"></script>
    <!-- ============================================================== -->	
    <!-- ============================================================== -->	   
	...
	?>
        <script src="<?php echo base_url(); ?>app_js/<?php echo $vista; ?>.js"></script>
		<!-- ?v=<?php echo(rand());?> -->
</body>
