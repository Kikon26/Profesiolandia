...
class CKike extends CI_Controller {
	...
	public function Usuario(){
		$resultado['usuario'] = $this->MKike->DetalleUsuario($this->input->get('id_cat_usuario'));				
	...
	public function update(){				
		...
		{        
			...
			else
			{
				...
				$resultado['update']=$this->MKike->update_usuario($file_name);                
				echo json_encode($resultado);
			}
		...
		{   			
			$resultado['update']=$this->MKike->update_usuario("");                
			echo json_encode($resultado);
		}
    }

	public function estado(){
		$resultado['estado'] = $this->MKike->CatalogoEstados();				
		echo json_encode($resultado);
	}
